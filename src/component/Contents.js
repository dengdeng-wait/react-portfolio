    ...
    <div>
      {profile ? 
        (<section key={profile.id}>
          <h2 className="mt-10 text-2xl text-gray-700 font-semibold dark:text-gray-300 font-mono"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" data-slot="icon" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
          </svg>{profile.years}</h2>
                      ...
                      <div className="w-full px-4 py-4">
                        <div className="flex-shrink-0">
                          <div className="flex items-center justify-center w-12 h-12 mx-auto mt-4 text-white bg-indigo-500 rounded-md">
                            <svg width="20" height="20" fill="currentColor" className="w-6 h-6" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M491 1536l91-91-235-235-91 91v107h128v128h107zm523-928q0-22-22-22-10 0-17 7l-542 542q-7 7-7 17 0 22 22 22 10 0 17-7l542-542q7-7 7-17zm-54-192l416 416-832 832h-416v-416zm683 96q0 53-37 90l-166 166-416-416 166-165q36-38 90-38 53 0 91 38l235 234q37 39 37 91z"></path></svg>
                          </div>
                        </div>
                        <h3 className="py-4 text-2xl font-semibold text-gray-700 sm:text-xl dark:text-white">{item.name}</h3>
                        <p className="pb-4 text-gray-500 text-md dark:text-gray-300">
                          <span>{item.position}</span><span className="mx-2 text-xs font-bold">/</span><span>{item.skill}</span>
                        </p>
                      </div>
                    </div>
                  </div>
